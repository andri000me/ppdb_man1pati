...
<body>
  ...
  <main id="main">
    ...
    <div class="jumbotron text-center">
      <section id="informasi" class="wow fadeIn">
        <div class="container text-center">
          ...
          <header class="section-header wow fadeInUp">
            <h3>Data Anda Sudah Tersimpan</h3>
            <p> <a href="https://chat.whatsapp.com/JH03B22VLMVGQffp4Puekt" target="_blank"> <button type="button" class="btn btn-success">JOIN GRUP </button></a><SMAll> <br> Silahan join ke Group WA PPDB MAN 2 Pati</SMAll></p>
          </header>
      ...
      <a href="<?php echo site_url('/'); ?>"><button type="button" class="btn btn-primary float-right">Keluar</button></a>
