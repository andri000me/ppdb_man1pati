      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 box">
            <a href="<?php echo base_url(); ?>assets/img/man5.jpg"><img src="<?php echo base_url(); ?>assets/img/man6.jpeg" class="img-responsive" style="width:100%;height: 300px;"></a>
          </div>
          <div class="col-lg-4 box">
          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-lg-7" style="background-color: #000;">
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/f1P9BhxLH5Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
              <div class="col-lg-5" style="background-color: green;height: 400px;">
                <h3 style="color: #fff;font-size: 20px;margin-top: 20px;margin-left: 10px;">PROFIL SEKOLAH</h3>
                <div class="jdl" style="border-bottom: 2px solid #fff;margin-left:10px;width: 100%;margin-top: -5px;">
                  ...
                  <p style="font-size: 14px;  line-height: 30px;  color: #fff;margin-bottom: 0;">kabupaten : Pati</p>
                  <p style="font-size: 14px;  line-height: 30px;  color: #fff;margin-bottom: 0;">Status Sekolah : Negeri </p>
                  <p style="font-size: 14px;  line-height: 30px;  color: #fff;margin-bottom: 0;">Jenjang : MA</p>
                  <p style="font-size: 14px;  line-height: 30px;  color: #fff;margin-bottom: 0;">Akreditasi : A</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="margin-top: 10px; height:auto;">
          ...
          <div class="col-lg-7" style="background-color: #000;">
            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/bsoMqhC52AU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

            <!-- <iframe width="100%" height="100%" src="https://www.youtube.com/embed/DV1jEiS3yxI" fram\border="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
          </div>
